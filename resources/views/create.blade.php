    ...
    <body class="bg-gray-100">
        <main class="container mx-auto py-8">
            <div class="text-center mb-12">
                <h1 class="text-4xl font-bold text-gray-800">Create a New Article</h1>
                ...
                <form action="{{ route('store') }}" method="POST" class="bg-white shadow-md rounded-lg p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="title" id="title"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg" placeholder="Article title"
                            required>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="flex justify-between items-center">
                        <a href="{{ route('articles') }}" class="text-gray-500 hover:text-gray-700">Cancel</a>
                        <button type="submit"
